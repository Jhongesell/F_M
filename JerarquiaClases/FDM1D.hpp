...
/// Clase para resolver problemas en una dimensión por el método de diferencias finitas
/** @author Antonio Carrillo Ledesma
    @date verano 2009
    @version 1.0.1
    @bug No hay errores conocidos
*/
class FDM1D : public F_M
{
private:
...
public:
   ...
   FDM1D(Problema_1D *pr, Geometria_1D *ge, ResuelveSistemaLineal *rsl) : F_M(pr,ge,rsl)
   {
      Pr = pr;
      Ge = ge;
