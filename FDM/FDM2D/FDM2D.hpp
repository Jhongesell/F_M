...
/// Clase para resolver problemas en dos dimensión por el método de diferencias finitas
/** @author Antonio Carrillo Ledesma
    @date verano 2009
    @version 1.0.1
    @bug No hay errores conocidos
*/
class FDM2D : public F_M
{
private:
...
public:
   ...
   FDM2D(Problema_2D *pr, Geometria_2D *ge, ResuelveSistemaLineal *rsl) : F_M(pr,ge,rsl)
   {
      Pr = pr;
      Ge = ge;
