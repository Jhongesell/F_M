//////////////////////////////////////////////////////////////////////////////////////////////
// Clase base para el método de elemento finito en tres dimensiones                         //
//                                                                                          //
...
/// Clase base para resolver problemas tipo Elemento finito en tres dimensiones
/** @author Antonio Carrillo Ledesma
    @date verano 2009
    @version 1.0.1
    @bug No hay errores conocidos
*/
class FEM3D : public F_M
{
protected:
...
public:
   ...
   FEM2D(Problema_3D *pr, Geometria_3D *ge, ResuelveSistemaLineal *rsl) : F_M(pr,ge,rsl)
   {
      Pr = pr;
      Ge = ge;
   }
