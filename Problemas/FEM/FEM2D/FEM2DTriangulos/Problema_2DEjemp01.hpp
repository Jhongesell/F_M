...
public:
   ...
   {
      // Dominio
      Dominio.asigna(0,0,-1.0);
      Dominio.asigna(0,1,-1.0);
   ...
   {
      if (di == 0) return ( (ln.dn1_X(x[0],x[1])*ln.dn1_X(x[0],x[1])) +  (ln.dn1_Y(x[0],x[1])*ln.dn1_Y(x[0],x[1])) );
      if (di == 1) return ( (ln.dn2_X(x[0],x[1])*ln.dn1_X(x[0],x[1])) +  (ln.dn2_Y(x[0],x[1])*ln.dn1_Y(x[0],x[1])) );
      if (di == 2) return ( (ln.dn3_X(x[0],x[1])*ln.dn1_X(x[0],x[1])) +  (ln.dn3_Y(x[0],x[1])*ln.dn1_Y(x[0],x[1])) );

      if (di == 3) return ( (ln.dn1_X(x[0],x[1])*ln.dn2_X(x[0],x[1])) +  (ln.dn1_Y(x[0],x[1])*ln.dn2_Y(x[0],x[1])) );
      if (di == 4) return ( (ln.dn2_X(x[0],x[1])*ln.dn2_X(x[0],x[1])) +  (ln.dn2_Y(x[0],x[1])*ln.dn2_Y(x[0],x[1])) );
      if (di == 5) return ( (ln.dn3_X(x[0],x[1])*ln.dn2_X(x[0],x[1])) +  (ln.dn3_Y(x[0],x[1])*ln.dn2_Y(x[0],x[1])) );

      if (di == 6) return ( (ln.dn1_X(x[0],x[1])*ln.dn3_X(x[0],x[1])) +  (ln.dn1_Y(x[0],x[1])*ln.dn3_Y(x[0],x[1])) );
      if (di == 7) return ( (ln.dn2_X(x[0],x[1])*ln.dn3_X(x[0],x[1])) +  (ln.dn2_Y(x[0],x[1])*ln.dn3_Y(x[0],x[1])) );
      if (di == 8) return ( (ln.dn3_X(x[0],x[1])*ln.dn3_X(x[0],x[1])) +  (ln.dn3_Y(x[0],x[1])*ln.dn3_Y(x[0],x[1])) );
   ...
   {
      return ((1.0 - x[0]*x[0])*(1.0 - x[1]*x[1]));
   }
   ...
   {
      return (2.0*(1.0 - x[1]*x[1]) + 2.0*(1.0 - x[0]*x[0]));
   }
